...
class SceneManager
{
    ...
    private:
        ...
        std::vector<std::pair<irr::scene::IAnimatedMeshSceneNode *, bool>> players;
	...
	public:
        ...
        /**
         * Turn physically the given player in the given direction
         *
         * @param idx Index of the player to move
         * @param dir Onscreen direction
         */
        void walkPlayer(int, t_dir);
         ...
         */
        void addNode(int, int, int, const std::string &texture = "");
